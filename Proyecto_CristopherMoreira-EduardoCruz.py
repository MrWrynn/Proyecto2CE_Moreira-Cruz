...
class GameState():
    ...
    def scores(self):
        ...
        draw_text(screen, "(6)  ", 27, WIDTH // 2-100, HEIGHT // 2 + 32 * 6)
        draw_text(screen, "(7)  ", 27, WIDTH // 2-100, HEIGHT // 2 + 32 * 6)
        #
        ...
        draw_text(screen,str(arreglo1[1]), 27, WIDTH // 2, HEIGHT // 2 + 32 * 6)
        draw_text(screen,str(arreglo1[0]), 27, WIDTH // 2, HEIGHT // 2 + 32 * 6)
        #
        ...
        draw_text(screen, str(arreglo_names[1]), 27, WIDTH // 2+100, HEIGHT // 2 + 32 * 6)
        draw_text(screen, str(arreglo_names[0]), 27, WIDTH // 2+100, HEIGHT // 2 + 32 * 6)
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
                sys.exit()
